        ...
        if (closestEnemy != null) {
            ...
            if (shouldRunAway()) {
                ...
                if (closestEnemyType == RobotType.HEADQUARTERS) {
                    ...
                    if (closestEnemyType == RobotType.CARRIER) {
                        distanceNeeded = RobotType.CARRIER.actionRadiusSquared + 1;
                    }
    ...
    public Direction chooseForwardDirection(MapLocation loc) throws GameActionException {
        ...
        for (int x = 0; x < dirsToConsider.length; x++) {
            ...
            if (rc.canMove(newDir)) {
                ...
                if (isPassible && noClouds && (currEnemiesSeen <= bestEnemiesSeen || bestEnemiesSeen == 0)) {
